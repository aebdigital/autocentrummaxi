    ...
    <div className="min-h-screen bg-dark-900">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl font-montserrat text-gray-300">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold font-exo mb-6 text-white">Nákup na splátky</h2>
          <ul className="list-disc ml-6 space-y-4 text-lg marker:text-lime-400">
        ...
        <section className="mb-12 bg-dark-800 p-8 rounded-lg shadow-sm border border-dark-600">
        ...
        <section>
          <h3 className="text-2xl font-bold font-exo mb-6 text-white">Spolupracujeme</h3>
          <div className="flex flex-wrap gap-8 items-center">
             {/* Placeholders for logos, can be added later */}
             <div className="text-gray-400 italic">Essox, Moneta, Home Credit...</div>
          </div>
        </section>
